...
<i>Auto Document Issue Register Updater allows the user to complete a Document Issue Register the quick and easy way implemented in just 3 clicks. Import 400 drawings inro blank register in just 6 seconds.</i>
<p align="left">
...
6. Clicks <b>Update Register</b> - app automatically populates the Excel register with drawing numbers, drawing names, sheet sizes, revisions, recipients and generates the dated PDF Document Issue Register 02-09-26.pdf in the output directory
