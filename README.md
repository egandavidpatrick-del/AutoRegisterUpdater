...
* [01. Auto Document Issue Register Updater User Guide](https://github.com/egandavidpatrick-del/AutoRegisterUpdater/blob/18e35af0ce2cc4bc7f6620499584ec7b03a04e68/guide/user-guide/AUTO%20DOCUMENT%20ISSUE%20REGISTER%20UPDATER%20USER%20GUIDE%20VERSION%201.0.pdf)
...
Auto Document Issue Register Updater is built like the structures I trust — with reinforced concrete and steel. What that means for your company's workflow:
...
- PDF Generation: Creates Document Issue Register [Date].pdf - A4/A3 selectable
...
6. Clicks <b>Update Register</b> - app automatically populates the Excel register with drawing numbers, drawing names, sheet sizes, revisions, recipients and generates the dated PDF Document Issue Register [Date].pdf in the output directory

Replaces manual copying of drawing names, dates and recipient details with an automated WinForms C# workflow that ensures consistency, accuracy across document issues.
